          ...
          <div className="col-lg-6">
            <div className="countdown-one__content">
              ...
              <p className="countdown-one__text">
                En la UDN te ofrecemos la oportunidad de estudiar en
                l&iacute;nea, brindandote formaci&oacute;n profesional de
                acuerdo a la demanda laboral actual. Te acompa&ntilde;aremos en
                tu proceso de aprendizaje desde el d&iacute;a uno hasta tu
                titulaci&oacute;n.
              </p>
            </div>
          </div>
            ...
            <div className="become-teacher__form">
              <div className="become-teacher__form-top">
                <h2 className="become-teacher__form-title">
                  Obt&eacute;n tu inscripci&oacute;n gratuita
                </h2>
              </div>
              {/*<form
                action="#"
